function getGithubInfo(user) {
    ...
    xhttp.onload = function () {
        //if the response is successful, it will show the user's details
        if (xhttp.status == 200) {
            console.log(xhttp);
...
function showUser(user) {
    ...
    console.log(user);
// setting the html elements in page using jQuery
    ...
    $(".information").html("<label style='font-size: x-large'><u><strong>User Information</strong></u></label>" +
        "<br/><br/><label style='font-size: larger'>Login Name : </label>"+ user.login
        +"<br/><label style='font-size: larger'> Login ID : </label>"+ user.id
        +"<br/><label style='font-size: larger'> Node ID : </label>"+ user.node_id
        +"<br/> <label style='font-size: larger'>GitHub URL : </label>"+link
        +"<br/> <label style='font-size: larger'>GitHub Repositories Of the User : </label>"+ user.public_repos);
